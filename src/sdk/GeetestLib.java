...
public class GeetestLib {
    ...
    private int registerChallenge(HashMap<String, String> data) {
        ...
        try {
            ...
            String param = "gt=" + this.captchaId + "&json_format="
                + this.json_format;
            ...
            if (return_challenge.length() == 32) {
                ...
                this.responseStr = this.getSuccessPreProcessRes(
                    this.md5Encode(return_challenge + this.privateKey));
    ...
    public int enhencedValidateRequest(String challenge, String validate,
        String seccode, HashMap<String, String> data) {
        ...
        String param = String.format(
            ...
            validate, seccode, this.json_format);
